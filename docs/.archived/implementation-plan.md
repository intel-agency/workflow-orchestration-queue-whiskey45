...
>
> **Scope:** Template repo `workflow-orchestration-queue-whiskey45` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
