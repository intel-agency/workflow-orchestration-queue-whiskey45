...
|---|---|---|---|
| `.github/workflows/orchestrator-agent.yml` | `workflow-orchestration-queue-whiskey45` | A, D | **DONE** |
| `.github/workflows/prompts/orchestrator-agent-prompt.md` | `workflow-orchestration-queue-whiskey45` | B, D | **DONE** |
| `.github/.labels.json` | `workflow-orchestration-queue-whiskey45` | C, D, L | **DONE** |
